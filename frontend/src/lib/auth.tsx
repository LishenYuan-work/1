...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return <Context.Provider value={{ user, loading, login, register, logout: () => { void supabase?.auth.signOut(); api.auth.logout().catch(() => undefined); setUser(null); } }}>{children}</Context.Provider>;
}
