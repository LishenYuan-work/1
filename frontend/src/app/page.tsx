  ...
  return <div className="review-shell">
    ...
    <main className="review-main">
      ...
      {view === "review" && <div className="page-content review-view">
        ...
        {(error || selected?.error_message) && <div className="error-banner"><AlertTriangle size={16} />{selected?.error_message || error}</div>}{notice && <div className="notice-banner"><CheckCircle2 size={16} />{notice}</div>}
      </div>}
